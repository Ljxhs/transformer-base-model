...
print("\n==============================")
print(" 运行实验: NoLayerNorm（禁用 LayerNorm）")
print("==============================\n")

train_loader, val_loader, _, _, _ = get_dataloaders()
model, device = build_model(use_layer_norm=False)
...
for epoch in range(1, N_EPOCHS + 1):
    ...
    if val_loss < best_val:
        best_val = val_loss
        torch.save(model.state_dict(), "model_NoLayerNorm.pt")

print(f"NoLayerNorm 最佳验证 Loss={best_val:.3f}")
